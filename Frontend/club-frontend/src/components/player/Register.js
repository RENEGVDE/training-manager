...
export default class Register extends Component {
    ...
    render() {
        const {name, email, password, position} = this.state;
                            ...
                            <Form.Row>
                                <Form.Group as={Col}>
                                    <InputGroup>
                                        ...
                                        <FormControl autoComplete="off" type="text" name="position" value={position} onChange={this.userChange}
                                            className={"bg-dark text-white"} placeholder="Enter Position"/>
                                    </InputGroup>
                                </Form.Group>
                            </Form.Row>
                        </Card.Body>
